...
<CH.Scrollycoding rows="focus" showCopyButton={true} showExpandButton={true} hasPreviewSteps={true} lineNumbers={true}>
## Setup
...
The app should look something like [this](http://localhost:5173/01/) now. It sure is nice having a designer who can also write the CSS, isn't it? (Thank you [Jim][jim] 🙏).
...
The error page should now look like the preview image
...
Preview placeholder1

---

Preview placeholder2

---

Preview placeholder3

---

Preview placeholder4

---

Preview placeholder5

---

Preview placeholder6

---

Preview placeholder7
...
<img
  ...
  alt="screenshot the first sidebar"
/>
...
Preview placeholder9

---

Preview placeholder10

---

Preview placeholder11
