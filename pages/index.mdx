...
An alternative take on [React Router's official tutorial][reactroutertutorial], built with [CodeHike][codehike].
...
[reactroutertutorial]: https://reactrouter.com/en/main/start/tutorial
