...
```jsx src/routes/contact.jsx
// from ../src/routes/contact.03.jsx
```
...
```jsx src/routes/contact.jsx
// from ../src/routes/contact.04.jsx
```
...
```jsx src/routes/contact.jsx
// from ../src/routes/contact.05.jsx
```
...
```jsx src/routes/contact.jsx
// from ../src/routes/contact.06.jsx
```
...
[reactroutertutorialapp]: https://yuleicul.github.io/react-router-tutorial
